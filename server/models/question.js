...
module.exports = {
  ...
  addQuestion: function(body) {
    ...
    let text = `INSERT INTO questions(product_id, question_body, question_date, asker_name, asker_email)
      VALUES ($1, $2, $3, $4, $5)`;
  ...
  updateHelpful: function(question_id) {
    let text = `UPDATE questions SET question_helpfulness=question_helpfulness + 1 WHERE question_id=$1`;
  ...
  report: function (question_id) {
    let text = `UPDATE questions SET reported=true WHERE question_id=$1`;
    let values = [question_id];
